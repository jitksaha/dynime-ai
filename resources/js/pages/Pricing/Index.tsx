...
export default function PricingIndex({ plans = FALLBACK_PLANS, currentPlanSlug = 'free' }: Props) {
    ...
    return (
        <div
            className="min-h-screen bg-[#fafafc] dark:bg-[#0c0c10] text-neutral-900 dark:text-neutral-100 flex flex-col justify-between selection:bg-[#635bff] selection:text-white transition-colors duration-200 relative"
            style={{
                fontFamily:
        ...
        >
            ...
            {/* Back to Chat Floating Link */}
            <Link
                href="/chat"
                className="fixed top-4 left-4 sm:top-6 sm:left-7 z-50 inline-flex items-center gap-2 text-xs font-medium text-neutral-700 hover:text-neutral-900 dark:text-neutral-300 dark:hover:text-white px-3 py-1.5 rounded-full bg-neutral-200/70 hover:bg-neutral-200 dark:bg-white/10 dark:hover:bg-white/20 transition-all shadow-xs"
            >
            ...
            {/* Main Content Area */}
            <div className="w-full max-w-5xl mx-auto px-4 sm:px-6 pt-8 sm:pt-10 pb-4 flex-1 flex flex-col justify-center">
